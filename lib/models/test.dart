...
void main() async {
  ...
  Event event1 = Event('John\'s Birthday', 'A fun party!', DateTime.now(), 'e1', 'New York', user1.id);
  Event event2 = Event('Jane\'s Wedding', 'A beautiful ceremony', DateTime.now(), 'e2', 'Paris', user2.id);
  Event event3 = Event('Alice\'s Conference', 'Tech conference', DateTime.now(), 'e3', 'San Francisco', user3.id);
  ...
  /////////////////////////////// fetching
  print('//////////////////////////////////////////////////////// fetching////////////////////////////////////////////////');
  print(giftMethods().getOneGift(gift1));
  print(giftMethods().getGiftsForEvent(event1));
  print(giftMethods().getGifts(user1));
  print('///////////////////////////////////////////////fetching friends////////////////////////////////////////');
Follow().getListFriends(user1);
print('///////////////////////////////////// fetching events////////////////////////////////////');

print(eventMethods().getEvent(event1));
print(eventMethods().getListEvents(user1));
